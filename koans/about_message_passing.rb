...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # The main difference I see is he use of symbols, but
    # I don't see how that is much different
    # I do believe that method names already are symbols though.
  end
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    # method_missing doesn't eliminate the correct respond_to behavior
